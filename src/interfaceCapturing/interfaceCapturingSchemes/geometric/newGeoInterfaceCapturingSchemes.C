...
)
{
    ...
    Info<< "Selecting interfaceCapturingScheme: "
        << geoInterfaceCapturingSchemesTypeName << endl;

    auto* ctorPtr = dictionaryConstructorTable(geoInterfaceCapturingSchemesTypeName);
    ...
    if (!ctorPtr)
    {
        ...
        (
            ...
            geoInterfaceCapturingSchemesTypeName,
